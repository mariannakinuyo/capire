...
<section class="container p-top">
  <div class="row">
    <div class="col-lg-6 offset-lg-3 my-5">
        <h3 class="lato highlight text-center"><strong><?php echo get_field('texto_do_topo_fr', $pageID) ?></strong></h3>
    </div>
  </div>
</section>
  ...
  <div class="row">
    <div class="offset-lg-1 col-lg-10">
      <div class="row">
        ...
        <?php
          $formatos_1 = get_field('formatos_1_fr', $pageID);
          if( $formatos_1 ) {
        ...
        <?php
          $formatos_2 = get_field('formatos_2_fr', $pageID);
          if( $formatos_2 ) {
